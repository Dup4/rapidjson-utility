...
[
...

    {
        ...
        auto json_string = rapidjson_utility::GetJsonString(doc);
...

    {
        ...
        auto sub_doc = std::invoke([]() -> rapidjson_utility::ResultOr<rapidjson::Document> {
            rapidjson::Document sub_doc;
            sub_doc.SetArray();
        ...
        auto sub_doc_1 = std::invoke([]() -> rapidjson_utility::ResultOr<rapidjson::Document> {
